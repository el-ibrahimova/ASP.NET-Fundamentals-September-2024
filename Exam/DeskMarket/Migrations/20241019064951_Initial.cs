        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Image of the product"),
                    SellerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "ID of the seller"),
                    AddedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date the product was added"),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "ID of the product category"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false, comment: "Shows that product is deleted or not")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductId = table.Column<int>(type: "int", nullable: false, comment: "ID of the product"),
