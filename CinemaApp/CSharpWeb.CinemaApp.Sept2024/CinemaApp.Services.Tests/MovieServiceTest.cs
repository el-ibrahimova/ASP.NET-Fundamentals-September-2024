    ...
    public class MovieServiceTest
    {
        ...
        public async Task GetAllMoviesNoFilterPositive()
        {
            ...
            IMovieService movieService =
                new MovieService(movieRepository.Object, cinemaRepository.Object, cinemaMovieRepository.Object);

            IEnumerable<AllMoviesIndexViewModel> allMoviesActual = await movieService.GetAllMoviesAsync(new AllMoviesSearchFilterViewModel());
        ...
        [TestCase("Av")]
        [TestCase("av")]
        public async Task GetAllMoviesSearchQueryPositiveCaseSensitive(string searchQuery)
        {
            int expectedMoviesCount = 1;
            //string expectedMovieId = this.moviesData
            //    .First(m => m.Title.ToLower().Contains(searchQuery.ToLower())).Id.ToString();
        ...
        [Test]
        public async Task GetAllMovieSearchQueryNegative()
        {
            IQueryable<Movie> moviesMockQueryable = moviesData.BuildMock();
            ...
            {
                IEnumerable<AllMoviesIndexViewModel> allMoviesActual = await movieService.GetAllMoviesAsync(null);
            });
